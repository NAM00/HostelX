...
<html lang="en" dir="ltr">
  ...
  <section id="main">
    <div class="container">
      <article id="maincol">
        <h1 class="pagetitle">Mid Budget Rooms</h1>
        <div class="mr_site">
            <a href="midrange.php" ><img src="./img/midroom.jpg" width="90%"> </a>
            <a href="midrange.php" ><h3 class="category">Mid Budget</h3></a>
          <p>This is a Low budget room. With the maximum number of bed is single room is 1. Which is double bed.</p>
        </div>
        <ul id="range">
          <li>
        ...
        <h3>Get Your Rooms</h3>
          <ul>
            <li> <a href="lowrange.php" class="category"> <label>Low Budget Rooms</label> </a> </li>
              <li> <a href="highrange.php" class="category"> <label>High Budget Rooms</label> </a> </li>
          </ul>
        </div>
      </aside>
    </div>
