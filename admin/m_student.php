...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  if(isset($_POST['va']))
  {
    $sqla = "SELECT id, name, rnum FROM tenant";
  ...
  if(isset($_POST['s1']))
  {
    ...
    $sqla = "SELECT id, name, rnum FROM tenant where id='$sid'";
    $resulta = mysqli_query($conn, $sqla);
    $rowCounta = mysqli_num_rows($resulta);
    echo "hi";
    unset($_POST['s1']);
  ...
  if(isset($_POST['s2']))
  {
    ...
    $sqla = "SELECT id, name, rnum FROM tenant where rnum='$rid'";
    $resulta = mysqli_query($conn, $sqla);
    $rowCounta = mysqli_num_rows($resulta);
    echo "hi";
    unset($_POST['s2']);
         ...
         <div align="center">
           ...
           <div class="light">
             <form action="m_student.php" method="post">
               ...
               <button type="submit" class="btnL" name="va">View all Tenant</button><br>
               ...
               <div id="search" align="right">
                 <table >
                   ...
                   <td> <label>Search</label> 
                    <input type="text" class="textareaL" placeholder="enter Student ID"name="sidtb" value=""><button type="submit" class="btnN" name="s1">search</button> </td>
                   </tr>
                   <tr>
                   <td> <label>Search Room</label> 
                    <input type="text" class="textareaL" placeholder="enter Room ID"name="ridtb" value=""> <button type="submit" class="btnN" name="s2">search</button></td>
                   </tr>
                  </form>
                   <tr>
                   <td>
