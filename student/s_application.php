...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
...

  {
    ...
    {
      $sql = "INSERT INTO APP (SUB,BODY,SEID) VALUES('$sub','$body','$uName' );";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <header>
      <div class="container">
        ...
        <li ><a href="student.php">Home</a></li>
          <li class="current"><a href="s_application.php"> Application</a></li>
          <li ><a href="s_complaints.php"> Complains</a></li>
    ...
    <section align ="center" id="addemp">
         <div class="m_emp">
          <form action="s_application.php" method="post">
           <table>
